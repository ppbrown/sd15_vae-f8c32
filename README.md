...
"normal" sd and sdxl vae, can be described as "f8c4":
8x scale, 4 channel.

Latest vaes like flux2, are 32 channel.

What happens if we put a 32 channel vae on sd1.5? Let's find out!

This experiment should go through multiple steps.

Step 1: Modify the sd1.5 model, and vae, so they have 32 channels instead
of just 4. 

Can we make it work and preserve the knowledge in some measure?
...
The most annoying part is that I havent learned enough about vae training to
maximize the output of this new vae. I have a partially trained version, but 
cant get it fully sharp.
...
Also keep in mind that only 4 out of the 32 channels have original model knowledge. So blend in training for the other 28 channels cautiously!
